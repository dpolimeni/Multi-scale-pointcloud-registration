...
from Preprocessor.farthestDownsampler import FarthesDownsampler
...
def main():
    ...
    fps_downsampler = FarthesDownsampler(N_POINTS_RANDOM_DS)
    voxel_downsampler = VoxelDownsampler(target_points_source, 0.05, 0.005, delta, stopping_delta)
