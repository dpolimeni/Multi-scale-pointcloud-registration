...
class FastGlobalOptimizer(IOptimizer):
    def __init__(
        ...
        self.fpfh_knn = (
            fpfh_knn  # TODO differentiate among normal estimate and fpfh extraction
        )
    ...
    def get_fpfh_features(
        ...
        source_copy.estimate_normals(
            o3d.geometry.KDTreeSearchParamHybrid(
                radius=self.fpfh_radius, max_nn=self.fpfh_knn
            )
        )
        ...
        source_fpfh_features = o3d.pipelines.registration.compute_fpfh_feature(
            source_copy,
            o3d.geometry.KDTreeSearchParamHybrid(
                radius=self.fpfh_radius_features, max_nn=self.fpfh_knn
            ),
        )
